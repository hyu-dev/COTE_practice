...
# 배경 이미지 불러오기
background = pygame.image.load("C:\\Users\\hyu63\\OneDrive\\바탕 화면\\PythonWorkspace\\pygame_basic\\background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:\\Users\\hyu63\\OneDrive\\바탕 화면\\PythonWorkspace\\pygame_basic\\character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:\\Users\\hyu63\\OneDrive\\바탕 화면\\PythonWorkspace\\pygame_basic\\enemy.png")
